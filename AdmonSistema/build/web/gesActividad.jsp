...
<%@page import="modelo.ActividadDAO, modelo.Actividad, java.util.List"%>
<%
  if (session.getAttribute("usuarioLogueado") == null) { response.sendRedirect("login.jsp"); return; }
  if (!"admin".equals(session.getAttribute("perfilUsuario"))) { response.sendRedirect("dashboard.jsp"); return; }
