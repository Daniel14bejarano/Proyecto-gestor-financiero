...
<html>
    <head>
        ...
        <style>
            ...
            .balance-card .valor.ingreso {
                color:var(--success);
            }
            .balance-card .valor.gasto   {
                color:var(--danger);
            }
        </style>
    </head>
        ...
        <div class="dash-wrapper">
            ...
            <div class="dash-body">
                <div class="dash-sidebar">
                    ...
                    <a href="listaUsuarios.jsp" class="sidebar-link admin-link">👥 Lista de usuarios</a>
                    <a href="gestionPerfiles.jsp" class="sidebar-link admin-link">👤 Gestión de perfiles</a>
                    <a href="regActividad.jsp"    class="sidebar-link admin-link">➕ Registro de actividades</a>
                    <a href="gesActividad.jsp"    class="sidebar-link admin-link">⚙️ Gestión de actividades</a>
                    <% }%>
                </div>
